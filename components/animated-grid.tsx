    ...
    <>
      <div className="mb-12 text-center sm:mb-16">
        <motion.div
          ...
          viewport={{ once: true }}
          className="mb-6 inline-flex items-center gap-2 rounded-full border border-primary/30 bg-linear-to-r from-primary/20 to-primary/10 px-4 py-2"
        >
          <Sparkles className="h-4 w-4 animate-pulse text-primary" />
          <span className="text-sm font-semibold text-primary">Features That Rock</span>
        </motion.div>
        ...
        >
          Why BuddhiAI{" "}
          <span className="animate-pulse bg-linear-to-r from-primary via-blue-500 to-purple-500 bg-clip-text text-transparent">
            Rocks
          </span>
        </motion.h2>
        <motion.p
...
const SkeletonOne = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="h-6 w-6 shrink-0 rounded-full bg-linear-to-r from-accent to-primary" />
...
const SkeletonTwo = () => {
  ...
  const widths = ["65%", "80%", "55%", "90%", "70%", "85%"];
  return (
    <motion.div
      initial="initial"
      animate="animate"
    ...
    >
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex h-4 w-full flex-row items-center space-x-2 rounded-full border border-neutral-100 bg-neutral-100 p-2 dark:border-white/20 dark:bg-black"
        ></motion.div>
      ))}
    </motion.div>
  );
