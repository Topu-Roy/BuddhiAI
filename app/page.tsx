      ...
      <main>
        ...
        <section className="relative flex min-h-[75dvh] w-full flex-col items-center justify-center px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="z-10 mx-auto max-w-4xl px-4 text-center">
            ...
            {/* Subtext */}
            <p className="mx-auto mb-8 max-w-lg text-base text-muted-foreground sm:max-w-xl sm:text-lg md:text-xl">
        ...
        {/* Features Section */}
        <section className="bg-accent px-4 py-16 dark:bg-card/40">
          <FeaturesBentoGrid />
        </section>
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
              {steps.map((step, index) => (
                <div key={index} className="relative">
                  <div className="h-full rounded-xl border bg-card p-6 transition-shadow hover:shadow-lg">
        ...
        {/* CTA Section */}
        <section className="flex items-center justify-center bg-accent px-4 py-16 sm:px-6 lg:px-8 dark:bg-card/40">
          <Card className="relative mx-auto flex h-[50dvh] max-w-6xl items-center justify-center rounded-lg px-12 text-center">
            <div className="z-10 flex h-full flex-col items-center justify-center">
              <h3 className="mb-4 text-3xl font-bold text-card-foreground">Ready to farm some brilliancy?</h3>
              <p className="mb-8 w-2/3 text-balance text-card-foreground/80">
      ...
      <footer className="bg-background py-8">
        <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
          <div className="mb-4 flex items-center justify-center">
            <Brain className="mr-2 h-6 w-6 text-muted-foreground" />
            <span className="font-semibold text-foreground">BuddhiAI</span>
          </div>
