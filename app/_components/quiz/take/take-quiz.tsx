...
export function TakeQuiz({ quizId }: { quizId: string }) {
    ...
    return (
      <Card className="flex items-center justify-center">
        <div className="space-y-4 text-center">
          ...
          <p className="text-2xl font-semibold text-destructive">Quiz not found</p>
          <p className="pb-4 text-muted-foreground">This quiz might not exist</p>
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 px-4 py-4">
      ...
      <Accordion>
        <AccordionItem value="item-1">
          ...
          <AccordionContent>
            ...
            <p className="pt-4 font-semibold text-muted-foreground">By {quiz.Profile?.name}</p>
          </AccordionContent>
        </AccordionItem>
      </Accordion>
      ...
      {/* Question */}
      <Card key={question.id} className="rounded-2xl bg-card/40 shadow-xl">
        <CardHeader>
        ...
        <CardContent>
          <RadioGroup
            ...
            onValueChange={v => {
              const selectedAnswerIndex = parseInt(v as string);
