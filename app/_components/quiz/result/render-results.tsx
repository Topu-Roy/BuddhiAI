          ...
          <div className="flex flex-col items-center justify-between gap-4 lg:flex-row">
            <div className="relative text-center lg:text-left">
              <div className="mb-3 flex items-center justify-center gap-3 lg:justify-start">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium text-muted-foreground sm:text-base">Overall Score</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex w-full flex-col items-center justify-between gap-4 md:flex-row">
              <div className="flex w-full items-center justify-between gap-4">
                <div className="group flex-1 rounded-xl border border-emerald-200/60 bg-linear-to-br from-emerald-50 to-emerald-100/50 p-5 text-center transition-all duration-200 hover:shadow-md dark:border-emerald-800/40 dark:from-emerald-950/30 dark:to-emerald-900/20">
                ...
                <div className="group flex-1 rounded-xl border border-red-200/60 bg-linear-to-br from-red-50 to-red-100/50 p-5 text-center transition-all duration-200 hover:shadow-md dark:border-red-800/40 dark:from-red-950/30 dark:to-red-900/20">
                  <div className="mb-2 flex items-center justify-center gap-2">
              ...
              <div className="group w-full rounded-xl border border-border/60 bg-linear-to-br from-muted/40 to-muted/20 p-5 text-center transition-all duration-200 hover:shadow-md">
                <div className="mb-2 flex items-center justify-center gap-2">
                ...
                <p className="text-xs font-medium text-muted-foreground sm:text-sm">Time Taken</p>
              </div>
            </div>
          </div>
        </CardContent>
      ...
      <div className="mb-8">
        ...
        <div className="space-y-6">
          {result.Quiz.questions.map((q, i) => {
            ...
            return (
              <Card key={q.localId} className="bg-card shadow-md dark:bg-card/40">
                <CardHeader>
                  <div className="flex items-center justify-between gap-4">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-primary/20 text-sm font-medium">
                      {i + 1}
                    </div>
                    {isCorrect ? (
                  ...
                  <CardTitle>
                    <p className="pt-2 text-base text-foreground">{q.question}</p>
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  ...
                  <div className="rounded-lg bg-muted/50 p-4">
                    <div className="mb-2 flex items-center gap-2">
                      ...
                      <p className="text-sm font-semibold text-foreground/80">Explanation</p>
                    </div>
