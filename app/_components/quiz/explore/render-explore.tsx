    ...
    return (
      <main className="mx-auto max-w-7xl px-4 py-10">
        ...
        <div className="flex w-full flex-col items-center justify-center pt-14">
          ...
          <p className="mt-8 text-destructive">Could not load quizzes.</p>
        </div>
      </main>
    );
  }
    ...
    <main className="mx-auto max-w-7xl p-4">
      ...
      {data.quizzes.length === 0 ? (
        <>
          <div className="flex w-full flex-col items-center justify-center pt-14">
            <HeartCrack className="text-destructive" />
            <p className="text-lg font-medium text-destructive">No quizzes yet.</p>
    ...
    <Card key={quiz.id} className="flex flex-col">
      ...
      <CardContent className="flex-1">
        <div className="flex items-center justify-between gap-2 text-sm text-muted-foreground">
          ...
          <Badge variant="outline" className="ml-2 shrink-0 text-muted-foreground">
            {quiz.createdWith ?? "-"}
          </Badge>
        </div>
      </CardContent>
