    ...
    <main className="container mx-auto max-w-7xl px-4 py-4 sm:py-8 lg:px-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-8 lg:grid-cols-3">
        ...
        <aside className="space-y-6">
          ...
          {/* Call-to-Action */}
          <Card className="border-0 bg-linear-to-br from-indigo-900/70 to-sky-900/70 shadow-sm">
            <CardContent>
              <div className="flex items-start gap-4">
                <Zap strokeWidth={1} size={40} className="text-secondary" />
                <div>
                  <p className="text-lg text-background dark:text-foreground/90">Daily Challenge</p>
                  <p className="text-sm text-background/80 dark:text-foreground/50">
