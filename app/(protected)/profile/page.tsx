          ...
          <CardContent className="relative">
            <div className="flex flex-col items-center space-y-4 text-center sm:flex-row sm:space-y-0 sm:space-x-6 sm:text-left">
              ...
              <div className="flex-1 space-y-2">
                ...
                <div className="flex flex-col space-y-1 text-muted-foreground sm:flex-row sm:items-center sm:space-y-0 sm:space-x-4">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                <h3 className="text-sm font-medium tracking-wide text-muted-foreground">Education Level</h3>
              ...
              <div>
                <h3 className="mb-3 text-sm font-medium tracking-wide text-muted-foreground">Interests</h3>
                <div className="flex flex-wrap gap-2">
                  {profile.interests.map((interest, index) => (
                    <Badge key={index} variant="secondary" className="bg-primary/10 text-xs text-foreground/80">
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid gap-4 md:grid-cols-2">
              <div>
                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase">User ID</h3>
                <p className="mt-1 font-mono text-sm">{profile.userId}</p>
              </div>
              <div>
                <h3 className="text-sm font-medium tracking-wide text-muted-foreground uppercase">Account ID</h3>
